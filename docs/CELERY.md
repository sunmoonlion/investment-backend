...
```bash
CELERY_BROKER_URL=amqp://investment-backend-producer:pass@localhost:5672/tpl-development
...
| 说明 | 模板 / 实例 |
|------|-------------|
| 应用代码 | `tpl-app/investment-backend/app/` |
| celeryworker 模板 | `tpl-app/celeryworker-investment-backend/` |
