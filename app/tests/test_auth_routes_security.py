...
async def test_admin_and_web_me_use_distinct_cookies_and_minimal_claims(
    ...
    fake_admin = FakeAuthService({"admin-session": session("admin", "investment:admin")})
    ...
    async with httpx.AsyncClient(
        ...
        client.cookies.set("sunmoonai_investment_admin_sid", "admin-session")
        ...
        client.cookies.set("sunmoonai_investment_web_sid", "web-session")
...
async def test_logout_is_post_only_and_surface_csrf_protected(
    ...
    async with httpx.AsyncClient(
        ...
        client.cookies.set("sunmoonai_investment_web_sid", "member")
