...
async def get_current_browser_session(
    request: Request,
    browser_session_id: str | None = Cookie(default=None, alias=SESSION_COOKIE),
    csrf_token: str | None = Header(default=None, alias="X-CSRF-Token"),
) -> BrowserSession:
    session = await _auth_service.get_browser_session(browser_session_id)
...
require_research_admin = require_scopes(ADMIN_SCOPE)
